...
<img src="img/banneratari.jpg" alt="Banner Jogos Atari" title="Banner Jogos Atari">
</section>
...
?>
  ...
  <table class="table table-striped">
    <thead class="fundotabgame">
      <tr>
        <th class="cortabatari" scope="col">Capa</th>
        <th class="cortabatari" scope="col">Jogo</th>
        <th class="cortabatari" scope="col">Data</th>
        <th class="cortabatari" scope="col">Gênero</th>
        <th class="cortabatari" scope="col">Desenvovedora</th>
        <th class="cortabatari" scope="col">Resumo</th>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td class="namegame"><?=$dados["nomeatari"]?></td>
      <td class="datagame"><?=$dados["dataatari"]?></td>
      <td class="gengame"><?=$dados["generoatari"]?></td>
      <td class="desengame"><?=$dados["desenatari"]?></td>
      <td class="singame"><?=$dados["sinatari"]?></td>
      </td>
    </tr>
