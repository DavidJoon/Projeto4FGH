...
<head>
  ...
  <title>Jogos Playstation 5</title>
</head>
...
<img src="img/bannerps5.png" alt="Banner Jogos PS5" title="Banner Jogos PS5">
</section>
...
?>
  ...
  <table class="table table-striped">
    <thead class="fundotabgame">
      <tr>
        <th class="cortabpscinco" scope="col">Capa</th>
        <th class="cortabpscinco" scope="col">Jogo</th>
        <th class="cortabpscinco" scope="col">Data</th>
        <th class="cortabpscinco" scope="col">Gênero</th>
        <th class="cortabpscinco" scope="col">Desenvovedora</th>
        <th class="cortabpscinco" scope="col">Resumo</th>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td class="namegame"><?=$dados["nomepscinco"]?></td>
      <td class="datagame"><?=$dados["datapscinco"]?></td>
      <td class="gengame"><?=$dados["generopscinco"]?></td>
      <td class="desengame"><?=$dados["desenpscinco"]?></td>
      <td class="singame"><?=$dados["sinpscinco"]?></td>
    </tr>
