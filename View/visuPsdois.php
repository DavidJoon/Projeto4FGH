...
<head>
  ...
  <title>Jogos Playstation 2</title>
</head>
...
<img src="img/bannerps2.jpg"  alt="Banner Jogos PS2" title="Banner Jogos PS2">
</section>
...
?>
  ...
  <table class="table table-striped">
    <thead class="fundotabgame">
      <tr>
        <th class="cortabpsdois" scope="col">Capa</th>
        <th class="cortabpsdois" scope="col">Jogo</th>
        <th class="cortabpsdois" scope="col">Data</th>
        <th class="cortabpsdois" scope="col">Gênero</th>
        <th class="cortabpsdois" scope="col">Desenvovedora</th>
        <th class="cortabpsdois" scope="col">Resumo</th>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td class="namegame"><?=$dados["nomepsdois"]?></td>
      <td class="datagame"><?=$dados["datapsdois"]?></td>
      <td class="gengame"><?=$dados["generopsdois"]?></td>
      <td class="desengame"><?=$dados["desenpsdois"]?></td>
      <td class="singame"><?=$dados["sinpsdois"]?></td>
    </tr>
