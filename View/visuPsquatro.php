...
<head>
  ...
  <title>Jogos Playstation 4</title>
</head>
...
<img src="img/bannerps4.jpg" alt="Banner Jogos PS4" title="Banner Jogos PS4">
</section>
...
?>
  ...
  <table class="table table-striped">
    <thead class="fundotabgame">
      <tr>
        <th class="cortabpsquatro" scope="col">Capa</th>
        <th class="cortabpsquatro" scope="col">Jogo</th>
        <th class="cortabpsquatro" scope="col">Data</th>
        <th class="cortabpsquatro" scope="col">Gênero</th>
        <th class="cortabpsquatro" scope="col">Desenvovedora</th>
        <th class="cortabpsquatro" scope="col">Resumo</th>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td class="namegame"><?=$dados["nomepsquatro"]?></td>
      <td class="datagame"><?=$dados["datapsquatro"]?></td>
      <td class="gengame"><?=$dados["generopsquatro"]?></td>
      <td class="desengame"><?=$dados["desenpsquatro"]?></td>
      <td class="singame"><?=$dados["sinpsquatro"]?></td>
    </tr>
