...
<img src="img/bannerps1.jpg" alt="Banner Jogos PS1" title="Banner Jogos PS1">
</section>
...
?>
  ...
  <table class="table table-striped">
    <thead class="fundotabgame">
      <tr>
        <th class="cortabpsum" scope="col">Capa</th>
        <th class="cortabpsum" scope="col">Jogo</th>
        <th class="cortabpsum" scope="col">Data</th>
        <th class="cortabpsum" scope="col">Gênero</th>
        <th class="cortabpsum" scope="col">Desenvovedora</th>
        <th class="cortabpsum" scope="col">Resumo</th>
     </tr>
    </thead>
    ...
    <tr>
      ...
      <td class="namegame"><?=$dados["nomepsum"]?></td>
      <td class="datagame"><?=$dados["datapsum"]?></td>
      <td class="gengame"><?=$dados["generopsum"]?></td>
      <td class="desengame"><?=$dados["desenpsum"]?></td>
      <td class="singame"><?=$dados["sinpsum"]?></td>
    </tr>
