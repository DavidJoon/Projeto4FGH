...
?>
  ...
  <table class="table table-striped">
    <thead class="fundotabgame">
      <tr>
        <th class="cortabxboxseries" scope="col">Capa</th>
        <th class="cortabxboxseries" scope="col">Jogo</th>
        <th class="cortabxboxseries" scope="col">Data</th>
        <th class="cortabxboxseries" scope="col">Gênero</th>
        <th class="cortabxboxseries" scope="col">Desenvovedora</th>
        <th class="cortabxboxseries" scope="col">Resumo</th>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td class="namegame"><?=$dados["nomexboxseries"]?></td>
      <td class="datagame"><?=$dados["dataxboxseries"]?></td>
      <td class="gengame"><?=$dados["generoxboxseries"]?></td>
      <td class="desengame"><?=$dados["desenxboxseries"]?></td>
      <td class="singame"><?=$dados["sinxxs"]?></td>
    </tr>
