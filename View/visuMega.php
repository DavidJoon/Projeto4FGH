...
<img src="img/bannermega.jpg" alt="Banner Jogos Mega Drive" title="Banner Jogos Mega Drive">
</section>
...
?>
  ...
  <table class="table table-striped">
    <thead class="fundotabgame">
      <tr>
        <th class="cortabmega" scope="col">Capa</th>
        <th class="cortabmega" scope="col">Jogo</th>
        <th class="cortabmega" scope="col">Data</th>
        <th class="cortabmega" scope="col">Gênero</th>
        <th class="cortabmega" scope="col">Desenvovedora</th>
        <th class="cortabmega" scope="col">Resumo</th>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td class="namegame"><?=$dados["nomemega"]?></td>
      <td class="datagame"><?=$dados["datamega"]?></td>
      <td class="gengame"><?=$dados["generomega"]?></td>
      <td class="desengame"><?=$dados["desenmega"]?></td>
      <td class="singame"><?=$dados["sinmega"]?></td>
      </td>
    </tr>
