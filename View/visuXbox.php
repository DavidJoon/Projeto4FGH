...
<img src="img/bannerxbox.jpg" alt="Banner Jogos Xbox" title="Banner Jogos Xbox">
</section>
...
?>
  ...
  <table class="table table-striped">
    <thead class="fundotabgame">
      <tr>
        <th class="cortabxbox" scope="col">Capa</th>
        <th class="cortabxbox" scope="col">Jogo</th>
        <th class="cortabxbox" scope="col">Data</th>
        <th class="cortabxbox" scope="col">Gênero</th>
        <th class="cortabxbox" scope="col">Desenvovedora</th>
        <th class="cortabxbox" scope="col">Resumo</th>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td class="namegame"><?=$dados["nomexbox"]?></td>
      <td class="datagame"><?=$dados["dataxbox"]?></td>
      <td class="gengame"><?=$dados["generoxbox"]?></td>
      <td class="desengame"><?=$dados["desenxbox"]?></td>
      <td class="singame"><?=$dados["sinxbox"]?></td>
    </tr>
