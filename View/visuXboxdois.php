...
<img src="img/bannerxboxdois.png" alt="Banner Jogos Xbox 360" title="Banner Jogos Xbox 360">
</section>
...
?>
  ...
  <table class="table table-striped">
    <thead class="fundotabgame">
      <tr>
        <th class="cortabxboxdois" scope="col">Capa</th>
        <th class="cortabxboxdois" scope="col">Jogo</th>
        <th class="cortabxboxdois" scope="col">Data</th>
        <th class="cortabxboxdois" scope="col">Gênero</th>
        <th class="cortabxboxdois" scope="col">Desenvovedora</th>
        <th class="cortabxboxdois" scope="col">Resumo</th>
      </tr>
    </thead>
    ...
    <tr>
      ...
      <td class="namegame"><?=$dados["nomexboxdois"]?></td>
      <td class="datagame"><?=$dados["dataxboxdois"]?></td>
      <td class="gengame"><?=$dados["generoxboxdois"]?></td>
      <td class="desengame"><?=$dados["desenxboxdois"]?></td>
      <td class="singame"><?=$dados["sinxboxdois"]?></td>
    </tr>
